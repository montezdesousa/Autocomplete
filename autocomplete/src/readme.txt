 ...
 * gostou de o fazer.                                             
 **************************************************************************** */
O projeto é interessante, no entanto na minha opinião parece-me demasiado avançado
para o conhecimento prático de Java que um aluno de 1º ano do ISCTE tem, 
tendo em conta que apenas tivemos contacto inicial em IP. A utilização de 
comparators não foi especialmente abordada nas aulas práticas, isso dificultou a 
criação e implementação apenas recorrendo à experiência das aulas.
